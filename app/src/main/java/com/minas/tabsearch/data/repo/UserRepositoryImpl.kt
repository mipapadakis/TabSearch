...
class UserRepositoryImpl(private val dao: IUserDao) : IUserRepository {
    ...
    override fun searchUsers(term: String): Flow<List<User>> = dao.searchUsers("%$term%")
    override fun searchFollowing(term: String): Flow<List<User>> = dao.searchFollowing("%$term%")
    override fun searchFollowers(term: String): Flow<List<User>> = dao.searchFollowers("%$term%")
